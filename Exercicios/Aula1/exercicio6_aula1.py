...
v = (vo**2+2*g*h)**0.5
print('a velocidade final do objeto é de aproximadamente', round(v,2), 'm/s')

# O tempo que o objeto leva para cair, por sua vez, pode ser obtido a partir de:
t = (v-vo)/g
print('o tempo que o objeto demora para cair é de aproximadamente', round(t,2), 'segundos')
