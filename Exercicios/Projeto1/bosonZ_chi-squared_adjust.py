...
# one that can be found in the literature:
    ...
    if abs(M_adjusted-M_reference) <= 2*uncertainty:
        print('A massa de', M_adjusted, 'que obtivemos É compatível com a da literatura')
    else:
        print('A massa de', M_adjusted, 'que obtivemos NÃO é compatível com a da literatura')
